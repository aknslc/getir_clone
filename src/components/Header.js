...
export default function Header() {
  return (
    <div className='bg-[#4C3398] sticky top-0 z-10'>
      <div className='container mx-auto h-11 flex items-center justify-between'>

        <a href='#' className='bg-[#5D3EBC] p-2 rounded-t-xl '>
        ...
        <nav className='flex gap-x-8 text-sm font-semibold'>
          ...
          <a href='#' className='text-white text-opacity-80 hover:text-opacity-100 transition-all flex items-center gap-x-2'>
            <BiGlobe size={20}/>
            <span className='hidden sm:block'>Türkçe (TR)</span>
          </a>
          <a href='#' className='text-white text-opacity-80 hover:text-opacity-100 transition-all flex items-center gap-x-2'>
            <FiUser size={20}/>
